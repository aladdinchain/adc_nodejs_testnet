...
var KeyPrivate = require('./auth/key_private');
var PublicKey = require('./auth/key_public');

var aes = require('./auth/aes');


var config = require('../config/config');

var version = config.version;
var operation_lib = "./serializer/operations";
var operations = require(operation_lib);
...
var encMemo = operations.encrypted_memo;
...
*/
Memo.decode = function(private_key, memo) {
    ...
    //Memo.checkEncryption();

    private_key = Memo.toPrivateObj(private_key);
...
*/
Memo.encode = function(private_key, public_key, memo, testNonce) {
    (0, _assert2.default)(memo, 'memo is required');
    _assert2.default.equal(typeof memo === 'undefined' ? 'undefined' : _typeof(memo), 'string', 'memo');
    if (!/^#/.test(memo)) return memo;
    memo = memo.substring(1);
    ...
    private_key = Memo.toPrivateObj(private_key);
    public_key = Memo.toPublicObj(public_key);
    ...
    var _Aes$encrypt = aes.encrypt(private_key, public_key, memo, testNonce),
...
Memo.checkEncryption = function () {
    if (encodeTest === undefined) {
        ...
        try {
            ...
            var cyphertext = Memo.encode(wif, pubkey, '#memo爱');
...
Memo.toPrivateObj = function(o) {
    return o ? o.d ? o : KeyPrivate.fromWif(o) : o /*null or undefined*/;
};
Memo.toPublicObj = function(o) {
